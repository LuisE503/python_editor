...
function ExamplesGallery({ onLoadExample, isRunning }) {
  ...
  const examples = [
    {
      ...
      category: 'basico',
      icon: '👋',
      description: 'Tu primer programa Python con variables, funciones y bucles',
    ...
    },
    {
      ...
      icon: '📊',
      description: 'Gráficos impresionantes con matplotlib: líneas, barras, dispersión y más',
      difficulty: 'Intermedio',
      time: '8 min'
    },
    {
      ...
      category: 'visual',
      icon: '🎨',
      description: 'Arte generativo: espirales de Fibonacci, fractales de Mandelbrot y patrones',
      difficulty: 'Avanzado',
      time: '10 min'
    },
    {
      ...
      category: 'algoritmos',
      icon: '🧮',
      description: 'Algoritmos de ordenamiento, búsqueda, Dijkstra y Torres de Hanoi',
      difficulty: 'Intermedio',
      time: '10 min'
    },
    {
      ...
      category: 'ml',
      icon: '🤖',
      description: 'ML desde cero: regresión, clustering, redes neuronales y KNN',
      difficulty: 'Avanzado',
      time: '12 min'
    },
    {
      ...
      category: 'juegos',
      icon: '🎮',
      description: 'Juegos clásicos: Game of Life, Sudoku, laberintos y Tic-Tac-Toe AI',
      difficulty: 'Avanzado',
      time: '15 min'
    },
    {
      ...
      category: 'seguridad',
      icon: '🔐',
      description: 'Hashing, cifrado César, XOR, generador de contraseñas y más',
      difficulty: 'Intermedio',
      time: '10 min'
    },
    {
      ...
      category: 'web',
      icon: '🌐',
      description: 'Extracción de datos, parseo HTML, APIs REST y procesamiento JSON',
      difficulty: 'Avanzado',
      time: '12 min'
    }
  ];
  ...
  const categories = [
    ...
    { id: 'basico', name: 'Básico', icon: '🌱', count: examples.filter(e => e.category === 'basico').length },
    { id: 'datascience', name: 'Data Science', icon: '📊', count: examples.filter(e => e.category === 'datascience').length },
    { id: 'visual', name: 'Visual', icon: '🎨', count: examples.filter(e => e.category === 'visual').length },
    { id: 'algoritmos', name: 'Algoritmos', icon: '🧮', count: examples.filter(e => e.category === 'algoritmos').length },
    { id: 'ml', name: 'Machine Learning', icon: '🤖', count: examples.filter(e => e.category === 'ml').length },
    { id: 'juegos', name: 'Juegos', icon: '🎮', count: examples.filter(e => e.category === 'juegos').length },
    { id: 'testing', name: 'Testing', icon: '🧪', count: examples.filter(e => e.category === 'testing').length },
    { id: 'seguridad', name: 'Seguridad', icon: '🔐', count: examples.filter(e => e.category === 'seguridad').length },
    { id: 'web', name: 'Web', icon: '🌐', count: examples.filter(e => e.category === 'web').length }
  ];
      ...
      <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 text-white">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-3xl font-bold mb-2">📚 Galería de Ejemplos</h2>
          ...
          <div className="relative">
            ...
            />
            <svg className="w-5 h-5 absolute left-4 top-1/2 transform -translate-y-1/2 text-purple-200" 
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-purple-600 to-indigo-600 p-4">
                    <div className="flex items-start justify-between">
                      ...
                      <div className={`${getDifficultyColor(example.difficulty)} px-2 py-1 rounded-full text-xs text-white font-medium`}>
                        {example.difficulty}
                      </div>
                    </div>
        ...
        <div className="bg-gray-800 border-t border-gray-700 px-6 py-4 text-center text-gray-400 text-sm">
          <p>💡 Tip: Haz clic en cualquier ejemplo para cargarlo en el editor</p>
        </div>
      </div>
    </div>
  );
