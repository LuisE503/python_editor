...
function CodeAnalyzer({ code }) {
  ...
  const analyzeCode = (sourceCode) => {
    ...
    const avgLineLength =
      codeLines.length > 0
        ? (
            codeLines.reduce((sum, line) => sum + line.length, 0) /
            codeLines.length
          ).toFixed(1)
        : 0;
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-2">
                <i className="fas fa-chart-bar"></i> Análisis de Código
              </h2>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gradient-to-br from-green-600 to-teal-600 rounded-xl p-4 text-white">
                <div className="text-3xl font-bold">
                  {analysis.structures.classes}
                </div>
                <div className="text-sm opacity-90">Clases</div>
              </div>
              <div
                className={`bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 text-white`}
              >
                <div
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <div className="text-gray-400 text-xs mt-1">
                    {(
                      (analysis.lines.code / analysis.lines.total) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <div className="text-gray-400 text-xs mt-1">
                    {(
                      (analysis.lines.empty / analysis.lines.total) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <div className="text-white text-2xl font-bold">
                    {analysis.metrics.avgLineLength}
                  </div>
            ...
            <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
              ...
              <div className="bg-gray-700 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                    className={`font-bold ${getComplexityColor(
                      analysis.metrics.complexity
                    )}`}
                  >
                ...
                <div className="w-full bg-gray-600 rounded-full h-3">
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        (analysis.metrics.complexity / 30) * 100,
                        100
                      )}%`,
                    }}
                  ></div>
                ...
                <p className="text-gray-400 text-sm mt-3">
                  ...
                  {analysis.metrics.complexity > 10 &&
                    analysis.metrics.complexity <= 20 &&
                    "⚠ Complejidad moderada - considera refactorizar"}
                  {analysis.metrics.complexity > 20 &&
                    "✗ Alta complejidad - refactorización recomendada"}
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <div className="text-white text-xl font-bold">
                    {analysis.metrics.characters.toLocaleString()}
                  </div>
                </div>
                <div className="bg-gray-700 rounded-lg p-3">
