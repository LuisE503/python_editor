...
function SettingsPanel({ settings, onSettingsChange }) {
  ...
  const themes = [
    { id: 'vs-dark', name: 'Dark (VS Code)', preview: 'linear-gradient(135deg, #1e1e1e 0%, #2d2d30 100%)' },
    { id: 'vs-light', name: 'Light', preview: 'linear-gradient(135deg, #ffffff 0%, #f3f3f3 100%)' },
    { id: 'hc-black', name: 'High Contrast', preview: 'linear-gradient(135deg, #000000 0%, #1a1a1a 100%)' },
    { id: 'monokai', name: 'Monokai', preview: 'linear-gradient(135deg, #272822 0%, #3e3d32 100%)' }
  ];
      ...
      <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-gradient-to-r from-pink-600 to-rose-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-2">⚙️ Configuración</h2>
              <p className="text-pink-100 text-sm">Personaliza tu experiencia</p>
            </div>
            <button
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
            ...
            <p className="text-gray-400 text-sm mt-2">Ajusta el tamaño del texto en el editor</p>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <div className="relative">
                ...
                <div className={`w-14 h-8 rounded-full transition-all duration-200 ${
                  ...
                  <div className={`w-6 h-6 bg-white rounded-full shadow-md transform transition-all duration-200 mt-1 ${
            ...
            <p className="text-gray-400 text-sm mt-2">Guarda tu código automáticamente en localStorage</p>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <div className="relative">
                ...
                <div className={`w-14 h-8 rounded-full transition-all duration-200 ${
                  ...
                  <div className={`w-6 h-6 bg-white rounded-full shadow-md transform transition-all duration-200 mt-1 ${
                    settings.wordWrap !== 'off' ? 'translate-x-7' : 'translate-x-1'
                  }`}></div>
                </div>
              </div>
              <span className="text-white text-lg">
            ...
            <p className="text-gray-400 text-sm mt-2">Ajusta automáticamente las líneas largas</p>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
            ...
            <p className="text-gray-400 text-sm mt-2">Muestra un minimapa del código a la derecha</p>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
            ...
            <p className="text-gray-400 text-sm mt-2">Configura cómo se muestran los números de línea</p>
          </div>
        </div>
