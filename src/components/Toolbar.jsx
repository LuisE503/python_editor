  ...
  return (
    <div className="toolbar relative">
      ...
      <div className="flex items-center gap-4 ml-auto">
        ...
        {/* Estado de Pyodide */}
        <div className={`flex items-center gap-2 text-sm ${isPyodideReady ? 'text-green-400' : 'text-yellow-400'}`}>
          <span className={`w-2 h-2 rounded-full ${isPyodideReady ? 'bg-green-400 animate-pulse' : 'bg-yellow-400 animate-bounce'}`}></span>
          ...
          <div className="space-y-2 text-sm">
            {[
              ...
              <div key={key} className="flex justify-between items-center">
                ...
                <kbd className="bg-gray-700 text-gray-300 px-2 py-0.5 rounded text-xs">{key}</kbd>
              </div>
            ))}
          </div>
          <button
