      ...
      <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-cyan-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-2">🔗 Compartir Código</h2>
              <p className="text-blue-100 text-sm">Comparte tu trabajo con otros</p>
            </div>
            <button
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-800 rounded-xl p-5 border border-gray-700 space-y-4">
              <div>
                ...
                <p className="text-gray-400 text-sm mb-3">
                  Copia este enlace para compartir tu código. El código está codificado en la URL.
                </p>
              ...
              <div className="bg-blue-500 bg-opacity-10 border border-blue-500 rounded-lg p-3">
                <p className="text-blue-300 text-sm">
                  💡 <strong>Tip:</strong> Cualquiera con este enlace podrá ver y ejecutar tu código.
                </p>
              </div>
            </div>
          )}
          ...
          {shareMethod === 'download' && (
            <div className="bg-gray-800 rounded-xl p-5 border border-gray-700 space-y-4">
              ...
              <div className="space-y-2">
                <h4 className="text-white font-medium text-sm">📊 Estadísticas del Código</h4>
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="bg-gray-700 rounded-lg p-3 text-center">
                    <p className="text-2xl font-bold text-cyan-400">{code.length}</p>
          ...
          {shareMethod === 'embed' && (
            <div className="bg-gray-800 rounded-xl p-5 border border-gray-700 space-y-4">
              <div>
                ...
                <p className="text-gray-400 text-sm mb-3">
                  Copia el código para compartirlo en foros, documentación o tutoriales.
                </p>
          ...
          <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                onClick={() => window.open(`https://twitter.com/intent/tweet?text=Mira mi código Python&url=${encodeURIComponent(shareUrl)}`, '_blank')}
